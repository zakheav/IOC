...
public class IOC {
	...
	public static void main(String[] args) {// 测试
		...
		Telephone telephone = (Telephone)ioc.getObject("telephone");
		Person person = (Person)ioc.getObject("person2");
		telephone.callContact();
		person.myTelephone.callContact();
	}
}
